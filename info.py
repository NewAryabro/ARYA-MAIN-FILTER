...
PICS = (environ.get('PICS', 'https://telegra.ph/file/439a82dc7ea249310c883.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002004133431').split()]
