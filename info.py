...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7179779107').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '') #Support group link ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002456481410') # If anyone sends a request message to your bot, you will get it in this channel.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "successive-lexi-arya-telegram-bots-095de85e.koyeb.app/")
